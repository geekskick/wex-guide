...
# Title: Top Block
# Generated: Sun Apr 28 16:20:56 2019
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.gain = gain = 0.5
        self.freq = freq = 88900000

        ##################################################
        # Blocks
        ##################################################
        self._sample_rate_range = Range(1000000, 10000000, 500000, 10000000, 200)
        self._sample_rate_win = RangeWidget(self._sample_rate_range, self.set_sample_rate, 'Samle Rate', "counter_slider", float)
        self.top_grid_layout.addWidget(self._sample_rate_win)
        self._gain_range = Range(0, 1, 0.01, 0.5, 200)
        self._gain_win = RangeWidget(self._gain_range, self.set_gain, 'Gain', "counter_slider", float)
        self.top_grid_layout.addWidget(self._gain_win)
        self._freq_range = Range(88000000, 470000000, 1000000, 88900000, 200)
        ...
        self.audio_sink_0 = audio.sink(sample_rate, '', False)
